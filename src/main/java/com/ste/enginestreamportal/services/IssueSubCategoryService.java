...
@Service
public class IssueSubCategoryService {

	@Autowired
	IssueSubCategoryRepository issueSubCategoryRepository;
	
	public Page<IssueSubCategory> findAllIssueSubCategory(Pageable pageable, String sortType, String searchWord, String statusType) {
        Page<IssueSubCategory> page = issueSubCategoryRepository.findAll(new Specification<IssueSubCategory>() {

			private static final long serialVersionUID = 1L;

			@Override
			public Predicate toPredicate(Root<IssueSubCategory> root, CriteriaQuery<?> query,
					CriteriaBuilder cb) {
                ...
                if (searchWord != null && !"".equals(searchWord)) {
                    ...
                    predicates.add(cb.or(cb.like(root.get("subCategoryName").as(String.class), pattern)));
                }
